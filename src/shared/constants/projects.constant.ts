...
export const PROJECTS: Array<TProject> = [
  ...
  },
  {
    ...
    description:
      "Simplify classroom management with our Teacher Attendance and Journal apps. Track student attendance effortlessly, record daily activities, and generate insightful reports to enhance communication with parents and improve student performance.",
    image: "/projects/absensi.jpg",
    languages: ["php", "Javascript", "Ajax", "Bootstrap.css"],
    domain: "https://github.com/tegarsaputradev/absensi-laravel-app",
  },
];
